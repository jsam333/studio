...
export const POWER_UP_COSTS: { [key in PowerUpType]?: number } = {
    ...
    BOMB_BRICK_L3: 10,
    RECOVERY_PADDLE: 10,
    RECOVERY_PADDLE_L2: 12,
    RECOVERY_PADDLE_L3: 14,
    BALL_BRICK: 7,
    BALL_BRICK_L2: 9, 
    BALL_BRICK_L3: 11, 
    POINTS_FIELD: 13,
...
export const POWER_UP_DESCRIPTIONS: { [key in PowerUpType | string]?: string } = {
    ...
    BUILDER_BALL: "Spawns a new ball at the paddle. It upgrades bricks on hit and transforms to a regular ball later",
    BUILDER_BALL_L2: "Spawns 2 new balls.",
    BUILDER_BALL_L3: "Spawns 3 new balls.",
    ...
    RECOVERY_PADDLE: "Makes balls stick to the paddle when lost nearby. Left click to release. Loads 2 sticky charges to paddle.",
    RECOVERY_PADDLE_L2: "Loads 4 sticky charges to paddle.",
    RECOVERY_PADDLE_L3: "Loads 6 sticky charges to paddle.",
