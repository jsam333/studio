...
export const POWER_UP_DESCRIPTIONS: { [key in PowerUpType | string]?: string } = {
    ...
    HOMING_BALL: "Makes 1 ball target nearest special brick on next paddle hit.",
    HOMING_BALL_L2: "Makes 2 balls target nearest special brick on next paddle hit.",
    HOMING_BALL_L3: "Makes 3 balls target nearest special brick on next paddle hit.",
    BOMB_BRICK: "Turns 1 brick into an exploding bomb brick.",
